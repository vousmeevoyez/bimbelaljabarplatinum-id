/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: ee16872406a892c9000300c485a3e709)
// Runtime types generated with workerd@1.20250803.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		EMAIL_FROM: "no-reply@bimbelaljabarplatinum.id";
		EMAIL_FROM_NAME: "bimbelaljabarplatinum.id";
		EMAIL_REPLY_TO: "support@bimbelaljabarplatinum.id";
		NEXTJS_ENV: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler */;
		NEXT_R2_BUCKET: R2Bucket;
		NEXT_TAG_CACHE_D1: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* bimbelaljabarplatinum-id */;
		ASSETS: Fetcher;
	}
}
