...
export const SITE_NAME = "Bimbel Aljabar Platinum"
export const SITE_DESCRIPTION = "Bimbel Aljabar PLatinum"
export const SITE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://bimbelaljabarplatinum.id"
export const GITHUB_REPO_URL = "https://github.com/vousmeevoyez/bimbelaljabarplatinum-id"
